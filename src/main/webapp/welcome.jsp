					...
					<div class="bk-widget bk-border-off bk-webkit-fix">
						...
						<div class="row">
							<div
								...
								<i class="fa fa-user"></i> 登录名 : ${bsUser.loginName}
							</div>
							<div
								class="col-12-4 col-md-12 col-sm-12 col-xs-12 bk-bg-white bk-padding-top-10">
						<i class="fa fa-book"></i> 密码  : ${bsUser.passWord}
							</div>
							<div
								class="col-12-4 col-md-12 col-sm-12 col-xs-12 bk-bg-white bk-padding-top-10">
								<i class="fa fa-star"></i> 年龄:${bsUser.age }
							</div>
							<div
								class="col-12-4 col-md-12 col-sm-12 col-xs-12 bk-bg-white bk-padding-top-10">
								<i class="fa fa-flag"></i> 性别:<c:if test="${bsUser.sex==1 }">
										男
									</c:if>
							...
							<div
								class="col-12-4 col-md-12 col-sm-12 col-xs-12 bk-bg-white bk-padding-top-10">
								<i class="fa fa-times-circle-o"></i> 创建时间:<fmt:formatDate value="${bsUser.created }" pattern="yyyy-MM-dd HH:mm:ss"/>
							</div>
