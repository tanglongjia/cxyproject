...
<html lang="en">
	<head>
		...
		<link href="<%=basePath %>assets/plugins/magnific-popup/css/magnific-popup.css" rel="stylesheet" />
		<!-- Theme CSS -->
	...
	<div class="modal fade bs-example-modal-lg" id="updatePwdModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		...
		<script src="<%=basePath %>assets/plugins/magnific-popup/js/magnific-popup.js"></script>
