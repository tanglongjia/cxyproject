                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div>
							...
							<div class="form-group">
	                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">菜单顺序：</label>
								<div class="col-lg-4 col-md-10">
									<input type="text" name="updateMenuOrder" class="form-control"  id="updateMenuOrder" >
								</div>
							</div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
	                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">菜单顺序：</label>
								<div class="col-lg-4 col-md-10">
									<input type="text" name="addMenuOrder" class="form-control"  id="addMenuOrder" >
								</div>
							</div>
                        </div>
                    </div>
    	...
    	$('#imgPath').iconpicker().on('change', function(e){
   		...
   		$.ajax({
   			...
   			success:function(str){
   				...
   				$("#updateMenuOrder").val(json.menuOrder);
