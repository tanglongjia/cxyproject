package com.cxy.web.annotation;
...
public class SystemLogAspect {
	...
	// Controller层切点
	@Pointcut("@annotation(com.cxy.web.annotation.SystemLogBeforeController)")
	public void controllerBeforeAspect() {
	}
	
	// Controller层切点
	@Pointcut("@annotation(com.cxy.web.annotation.SystemLogAfterController)")
	public void controllerAfterAspect() {
	}
	
	//service层切点
	@Pointcut("@annotation(com.cxy.web.annotation.SystemLogService)")
